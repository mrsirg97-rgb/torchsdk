...
> TypeScript SDK for the Torch Market protocol on Solana. Version 2.1.0.
...
│  getVaultWalletLink()    │  │  buildCreateVaultTx()      │
│                          │  │  buildDepositVaultTx()     │
...
└── torch_market.json   Anchor IDL (v3.1.1, 28 instructions)
```
